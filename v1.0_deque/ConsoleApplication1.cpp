...
int main()
{
    ...
    deque<Studentas> normalus;
    deque<Studentas> nenormalus;
    deque<Studentas> studentai1;
    ...
    while (true)
    {
        ...
        else if (pasirinkimas == 6)
        {
            ...
            default: cout << "Netinkamas pasirinkimas. Praðome ávesti tinkamà pasirinkimà: " << endl; return 1;
            }
    ...
    cout << "Deque programos versija baigta. Paspauskite bet koká mygtukà ir ENTER norint uþbaigti programà..." << endl;
    int a;
    cin >> a;
    return 0;
}