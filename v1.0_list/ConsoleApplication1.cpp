...
int main()
{
    ...
    srand(time(NULL));
    list<Studentas> studentai, studentai1, studentai2, normalus, nenormalus;
    int pasirinkimas;
    ...
    while (true)
    {
    	...
    	cout << "List programos versija baigta. Paspauskite bet koká mygtukà ir ENTER norint uþbaigti programà..." << endl;
	int a;
	cin >> a;
	return 0;
}